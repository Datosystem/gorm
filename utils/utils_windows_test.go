...
func TestSourceDir(t *testing.T) {
	cases := []struct {
		...
		{
			file: `C:/Users/name/go/pkg/mod/github.com/Datosystem/gorm/@v1.2.3/utils/utils.go`,
		...
		{
			file: `C:/go/work/proj/my.github.com/Datosystem/gorm/@v1.2.3/utils/utils.go`,
			want: `C:/go/work/proj/my.github.com/Datosystem/gorm/@v1.2.3/`,
		},
	}
	for _, c := range cases {
		s := sourceDir(c.file)
